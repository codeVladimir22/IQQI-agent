...
# Configuration
IQQI_INSTALL_BASE_URL="${IQQI_INSTALL_BASE_URL:-https://github.com/codeVladimir22/IQQI-agent}"
REPO_URL_SSH="${IQQI_REPO_URL_SSH:-git@github.com:codeVladimir22/IQQI-agent.git}"
REPO_URL_HTTPS="${IQQI_REPO_URL_HTTPS:-https://github.com/codeVladimir22/IQQI-agent.git}"
